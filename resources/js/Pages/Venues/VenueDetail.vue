...
<template>
    <AppLayout>
                ...
                <div>
                    ...
                    <div class="mt-4 max-w-[60ch]">
                        <p class="text-sm font-light text-slate-500">
                            ...
                            elit. Accusamus possimus nisi vero perspiciatis
                            error eligendi quaerat eius quam est minus!
                        </p>
                    </div>
                </div>
        ...
        >
            <div
                class="flex justify-between gap-6 flex-wrap bg-white flex-1 rounded-lg shadow-md drop-shadow-lg overflow-hidden w-full relative hover:bg-slate-100 transition ease-in-out duration-200 p-4"
            >
                <!-- Image Venue -->
