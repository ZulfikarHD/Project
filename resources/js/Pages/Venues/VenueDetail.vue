  ...
  <AppLayout>
    ...
    <section>
      ...
      >
        <!-- Main Image -->
        <div
          class="w-full rounded-lg h-48 lg:h-96 shadow drop-shadow bg-slate-200"
        ></div>
        ...
        <div class="md:flex gap-4 justify-between hidden">
          <template v-for="i in 4" :key="i">
            <div
              class="rounded-lg h-32 w-64 shadow drop-shadow bg-slate-200 flex-auto"
            ></div>
          </template>
        </div>
      </div>
    ...
    >
      <div class="flex justify-between gap-4 flex-wrap">
        ...
        <div>
          <!-- Venue Name -->
          <h1 class="font-bold text-xl">Sehat Sport</h1>
          ...
          <div class="flex items-center mt-2 leading-tight">
            ...
            <p class="text-sm">08.00 - 21.00 (setiap hari)</p>
          </div>
          ...
          <div class="mt-4 max-w-[60ch]">
            <p class="text-sm font-light text-slate-500">
              ...
              Accusamus possimus nisi vero perspiciatis error eligendi quaerat
              eius quam est minus!
            </p>
          </div>
        </div>
    ...
    >
      ...
      <iframe
        ...
        class="w-full h-36 bg-slate-200 rounded-lg shadow drop-shadow"
        style="border: 0"
        allowfullscreen=""
        loading="lazy"
      ...
      >
        ...
        <div class="flex flex-col gap-4 w-full md:w-fit">
          <img
            src=""
            alt="field Pic"
            class="w-full min-w-0 md:min-w-96 h-48 bg-slate-400 rounded-lg shadow drop-shadow"
          />
          ...
          <div class="lg:grid grid-cols-2 hidden gap-4">
            <img
              src=""
              alt="field Pic"
              class="w-48 h-24 bg-slate-400 rounded-lg shadow drop-shadow"
            />
            <img
              src=""
              alt="field Pic"
            ...
            <div>
              ...
              <div class="mt-4 max-w-[30ch]">
                <p class="text-sm font-light text-slate-500 line-clamp-3">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                  Accusamus possimus nisi vero perspiciatis error eligendi
                  quaerat eius quam est minus!
                </p>
              </div>
            </div>
