                ...
                <div class="p-4">
                    ...
                    <form @submit.prevent="createBudget">
                        <div class="mb-4">
                            ...
                            <input type="text" id="budgetName" v-model="newBudget.name" class="mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="budgetAmount" class="block text-sm font-medium text-gray-700">Amount</label>
                            <input type="number" id="budgetAmount" v-model="newBudget.amount" class="mt-1 block w-full" required>
                        </div>
            ...
            <Card class="mb-8" v-if="selectedBudget">
                <div class="p-4">
                    ...
                    <form @submit.prevent="updateBudget">
                        <div class="mb-4">
                            <label for="adjustedBudgetName" class="block text-sm font-medium text-gray-700">Budget Name</label>
                            <input type="text" id="adjustedBudgetName" v-model="selectedBudget.name" class="mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="adjustedBudgetAmount" class="block text-sm font-medium text-gray-700">Amount</label>
                            <input type="number" id="adjustedBudgetAmount" v-model="selectedBudget.amount" class="mt-1 block w-full" required>
                        </div>
